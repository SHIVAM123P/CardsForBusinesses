  ...
  return (
    <section className="relative bg-background text-center py-20 md:py-32">
       <div className="container mx-auto px-4 z-10">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight font-headline text-primary text-shadow-funky">
          Crafting Connections, One Card at a Time.
        </h1>
        <p className="mt-6 max-w-2xl mx-auto text-lg md:text-xl text-muted-foreground">
          At Cardfolio, we design business cards that make a lasting impression.
